...
class Openhouse2016ActionClient
{
	public:
	    Openhouse2016ActionClient();
	    ~Openhouse2016ActionClient();
	...
	private:
		...
		//void Openhouse2016ActionClient::contextIndependentBehaviorCallback(const perceptual_filter::AudienceBehavior &msg);
