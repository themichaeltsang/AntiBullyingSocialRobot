#ifndef PERCEPTUAL_FILTER_POSERECOGNIZER_H_
#define PERCEPTUAL_FILTER_POSERECOGNIZER_H_
...
class PoseRecognizer{
	...
	public:
		...
		//std::map<std::string, tf::Vector3> GetNormalizedJointPositions(std::map<std::string, tf::Transform> joint_transforms_map, std::string context = "fully_body");
		std::map<std::string, tf::Vector3> GetNormalizedJointPositions(std::map<std::string, tf::Vector3> joint_transforms_map, std::string root);

		std::map<std::string, double> GetNormalizedJointAngles(std::map<std::string, tf::Vector3> joint_positions_map, std::string context = "fully_body");
